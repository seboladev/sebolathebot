...
function changing_status() {
    let status = [`Servindo ${client.users.size} usuários com muito amor 💖`, `e espalhando alegria a ${client.guilds.size} servidores ❤`, 'Use se!help para a lista de ajuda', 'Versão v1.20.0.b.24.12.19', 'Me adicione! se!invite']
...
client.on("message", async message => {
            ...
            if (command === "invite") {
                ...
                const helpEmbed = new Discord.RichEmbed()
                    ...
                    .setDescription(`Se você procura me adicionar [clique aqui](${link}), e se quiser entrar no meu servidor de suporte [clique aqui](${sesv}).`)
                    .setTimestamp()
                    .setFooter('Sebola, o bot');
            ...
            if (command === "botinfo") {
                const botinfoEmbed = new Discord.RichEmbed()
                    ...
                    .addField('**Versão**', 'v1.20.0.b.24.12.19', true)
                    .addField('**Ultima atualização**', '24/12/19', true)
            ...
            if (command === "help") {
                const helpEmbed = new Discord.RichEmbed()
                    ...
                    .addField('**Ações** (4 comands)', '`kiss, hug, headpat, slap`', false)
            ...
            if (command === "headpat") {
                if (message.mentions.members.size == 0) {
                    const headpat1ErrEmbed = new Discord.RichEmbed()
                        ...
                        .addField('**Variables:**', 'se!cafuné', false)
...
client.on("message", message => {
    ...
    if (userInfo.xp > 150) {
        ...
        const lvlupEmbed = new Discord.RichEmbed()
            ...
            .setDescription(`Parabéns <@${message.author.id}> pela sua determinação você passou de nível! Agora você está no nível ${userInfo.level}`)
    ...
    if (cmd === "level") {
        ...
        let embed = new Discord.RichEmbed()
            .setColor(0x4286f4)
            .setAuthor(`Nível de ${message.author.tag}`, message.author.avatarURL)
            .addField("**Nível**", userInfo.level)
